...
from routers import clan, war, capital, games, members, settings, notify, events, music, member_auth, chat, shop, clans, push, insights, weekly_stats, medals, reputation, quests, rules
